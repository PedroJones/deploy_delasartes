                ...
                <Card className='cardbackgroundSobre displaycardSobre'>
                    ...
                    <div className='displaytextSobre devteamtext pgrightp'>
                        <div>
                            <h1>PEDRO JONES</h1>
                            <p>Dev Full Stack</p>
                            <h2>Próximo de se graduar em um curso superior de filosofia, me encontro atualmente em transição de carreira para atuar como desenvolvedor. Tendo-me capacitado através do curso da Generation Brasil, tenho o que é preciso para engressar nessa nova carreira.</h2>
                        </div>
